fetch(`https://api.tiendanube.com/v1/2635996/scripts`, {
          method: "POST",
          body: JSON.stringify({
            src: "https://azrfvrstorageresources.z13.web.core.windows.net/tiendanube/testscript.js",
            event: "onfirstinteraction",
            where: "store,checkout",
          }),
          headers: {
            "Content-type": "application/json",
            Authentication: "bearer 07ad6dd5ac5aa3f38305c0f2d4d5c23218a0c5f3",
          },
        })
          .then((res) => res.json())
